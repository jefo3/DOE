                    ...
                    <Col xs={12} md={12}>
                        <Card>
                                    ...
                                    <Col>
                                        ...
                                        <Card.Text>
                                            <ListGroup variant="flush" style={{height: "100px", overflow:"auto", width: "100%"}}>
                                                <ListGroup.Item>Cras justo odio <Button variant="primary">Chat</Button> <Button variant="primary">Aceitar</Button></ListGroup.Item>
                                                <ListGroup.Item>Cras justo odio <Button variant="primary">Chat</Button> <Button variant="primary">Editar</Button></ListGroup.Item>
                                                <ListGroup.Item>Cras justo odio  <Button variant="primary">Chat</Button> <Button variant="primary">Editar</Button></ListGroup.Item>
                                            </ListGroup>
                                        </Card.Text>
                                    </Col>}
                            ...
                            <Card.Footer className="text-muted" style={{ fontSize: "12px" }}>
                                Criado em: {donate.created_at}
                                {!donate.status_donate.includes("finalizada") && <ButtonsContainer>
                                    <Button variant="primary">Editar</Button>
                                    <Button variant="danger">Excluir</Button>
                                </ButtonsContainer>}
                                <div> Atualizado em: {donate.updated_at} </div>
                            </Card.Footer>
                        </Card>
                    </Col>
                ))}
