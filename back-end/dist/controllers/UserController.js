...
var ListUserService_1 = __importDefault(require("../services/user/ListUserService"));
var UserController = /** @class */ (function () {
    function UserController() {
    }
    UserController.prototype.create = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, name_1, surname, email, password, user, error_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        _a = request.body, name_1 = _a.name, surname = _a.surname, email = _a.email, password = _a.password;
                        return [4 /*yield*/, new CreateUserService_1.default().execute({
                                name: name_1,
                                surname: surname,
                                email: email,
                                password: password,
    ...
    UserController.prototype.update = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var id, _a, email, password, userUpdated, error_2;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        ...
                        return [4 /*yield*/, new UpdateUserService_1.default().execute({
                                id: id,
                                email: email,
                                password: password,
                            })];
    ...
    UserController.prototype.delete = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var id, userDeleted, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        id = request.params.id;
                        return [4 /*yield*/, new DeleteUserService_1.default().execute({
                                id: id,
                            })];
                    case 1:
                        userDeleted = _a.sent();
                        return [2 /*return*/, response.json(userDeleted)];
                    case 2:
                        error_3 = _a.sent();
    ...
    UserController.prototype.list = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, new ListUserService_1.default().execute()];
                    case 1:
                        users = _a.sent();
