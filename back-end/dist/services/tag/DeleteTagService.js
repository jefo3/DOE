...
var DeleteTagService = /** @class */ (function () {
    function DeleteTagService() {
    }
    DeleteTagService.prototype.execute = function (_a) {
        var id = _a.id;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, tagRepository.findOne(id)];
                    case 1:
                        tag = _b.sent();
                        if (!tag) {
                            throw new Error('Tag dont exist');
                        }
                        return [4 /*yield*/, tagRepository.delete(tag.id)];
                    case 2:
                        _b.sent();
                        return [2 /*return*/, tag];
                }
